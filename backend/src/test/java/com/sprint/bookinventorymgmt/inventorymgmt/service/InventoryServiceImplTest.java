...
class InventoryServiceImplTest {
    ...
    void updateSuccess() {
        ...
        updated.setIsbn("99999");
        updated.setRanks(2);
        updated.setPurchased(false);
        ...
        assertEquals(
                200,
                service.updateInventory(1, updated)
                        .getStatusCode()
        );
    }
    ...
    // NEGATIVE 5
    @Test
    void deletePurchasedInventoryBlocked() {
    ...
    // NEGATIVE 6
    @Test
    void updatePurchasedInventoryBlocked() {
